  ...
  const samplePosts: Post[] = [
    {
      ...
      content: 'Just discovered the new React 19 features! The use() hook is game-changing. No more useEffect for data fetching. What are your thoughts on this approach? 🚀',
      ...
      comments: [
        {
          ...
          content: 'This is amazing! Finally, a cleaner way to handle async data.',
          likes: 12,
    ...
    },
    {
      ...
      content: 'How do I properly handle authentication in Next.js 14 with App Router? Should I use middleware or server actions?',
      ...
      comments: [
        {
          ...
          content: 'I recommend using NextAuth.js with middleware. It provides a seamless experience.',
          likes: 45,
    ...
    },
    {
      ...
      content: 'TypeScript 5.3 is here! The new narrowing capabilities are incredible. Check out this example:',
